...
<html>
    ...
    <?php
 defined('SAE_MYSQL_HOST_M') or define('SAE_MYSQL_HOST_M', '127.0.0.1'); defined('SAE_MYSQL_PORT') or define('SAE_MYSQL_PORT', '3306'); ?>
    <h1>创建数据库</h1>
    <form action="/tom/install.php?s=/Index/step2.html" method="post" target="_self">
        <div class="create-database">
            ...
            <div>
                <input type="text" name="db[]" value="tom_">
    ...
    <a class="btn btn-success btn-large" href="<?php echo U('Index/step1');?>">上一步</a>
